...
face_cascade.load('E:/opencv/opencv/sources/data/haarcascades/haarcascade_frontalface_default.xml')
# https://github.com/Itseez/opencv/blob/master/data/haarcascades/haarcascade_eye.xml
eye_cascade = cv2.CascadeClassifier('haarcascade_eye.xml')
eye_cascade.load('E:/opencv/opencv/sources/data/haarcascades/haarcascade_eye.xml')

eyeglasses_cascade = cv2.CascadeClassifier('haarcascade_eye_tree_eyeglasses.xml')
eyeglasses_cascade.load('E:/opencv/opencv/sources/data/haarcascades/haarcascade_eye_tree_eyeglasses.xml')
smile_cascade = cv2.CascadeClassifier('haarcascade_smile.xml')
smile_cascade.load('E:/opencv/opencv/sources/data/haarcascades/haarcascade_smile.xml')
