...
class my_Window(QMainWindow,Ui_MainWindow):
    def __init__(self):
        ...
        self.Button.clicked.connect(self.displayText) #点击按钮在文本框中显示信息
        self.command =''   #文本框输入的命令
        self.show()

    def displayText(self):  #设置文本框显示信息
        self.textEdit.setPlainText("开始使用")
